...
function SrsRtcPublisherAsync({ facingMode = 'user', deviceId = '' }) {
  var self = {}
  ...
  //      webrtc://r.ossrs.net:1443/live/livestream
  // or autostart the publish:
  //      webrtc://r.ossrs.net/live/livestream?autostart=true
  // or change the app from live to myapp:
  //      webrtc://r.ossrs.net:1443/myapp/livestream
  // or change the stream from livestream to mystream:
  //      webrtc://r.ossrs.net:1443/live/mystream
  ...
  self.__internal = {
    ...
    prepareUrl: function (webrtcUrl) {
      ...
      var apiUrl = 'https://' + urlObject.server + ':' + port + api
    ...
    parse: function (url) {
      ...
      var port = a.port
      if (!port) {
        // Finger out by webrtc url, if contains http or https port, to overwrite default 443.
      ...
      if (!ret.port) {
        if (schema === 'webrtc' || schema === 'rtc') {
          if (ret.user_query.schema === 'https') {
            ...
            // For WebRTC, SRS use 443 as default API port.
            ret.port = 443
          }
        }
      }
...
function SrsRtcWhipWhepAsync() {
  ...
  //      http://localhost:443/rtc/v1/whip/?app=live&stream=livestream
  self.publish = async function (url) {
  ...
  // See https://datatracker.ietf.org/doc/draft-ietf-wish-whip/
  // @url The WebRTC url to play with, for example:
  //      http://localhost:443/rtc/v1/whip-play/?app=live&stream=livestream
  self.play = async function (url) {
