  ...
  return (
    <div className="relative group">
      {isShowTooltip && (
        <div
          ref={popUp}
          className={`absolute -translate-x-[2/4] -left-1/2 duration-200 xl:block hidden  min-w-[311px] max-w-[320px] ${
        ...
        >
          ...
          <div className="absolute w-[60px] h-[60px]  bg-white  flex justify-center items-center rounded-full -top-[38px] translate-x-2/4 left-[50%] -ml-[60px] z-[100]">
            ...
            <div className="absolute">
              <div className="relative w-[25.3px] h-[30.4px]">
                <Image
                  src="/images/Portfolio/gau.png"
                  layout="fill"
                  alt=""
                  quality={100}
                />
      ...
      <div
        ...
        className={`relative py-[8px] px-[16px] bg-[#EAEDF5] rounded-[12px] ${
...
BadgeBearSkill.propTypes = {}
BadgeBearSkill.defaultProps = {}

export default BadgeBearSkill
