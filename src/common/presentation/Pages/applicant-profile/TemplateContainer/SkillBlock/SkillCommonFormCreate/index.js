...
const SkillCommonFormCreate = (props) => {
  const {
    handleCancle,
    btnRef,
    skillsCommon,
  ...
  const selectNewSkillCommon = () => {
    if (isNaN(parseInt(keySearch.common))) {
    ...
    <div>
      <div>
        ...
        <div className="relative" ref={refCommonOpt}>
          ...
          {showOpt.common && (
            <div
              className={`bg-white max-h-[180px] p-2 w-full overflow-x-hidden absolute border border-grey-3 rounded-lg custom-scrollbar z-10`}
              style={{
            ...
            >
              ...
              {keySearch?.common?.trim() !== '' &&
                listSkill?.common?.length === 0 && (
                  <div
...
SkillCommonFormCreate.propTypes = {
...
SkillCommonFormCreate.defaultProps = {
  handleCancle: () => {},
  handleCreateItem: () => {},
  defaultValues: {},
  skillsAdvanced: [],
...
export default SkillCommonFormCreate
