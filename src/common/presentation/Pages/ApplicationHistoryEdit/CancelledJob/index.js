              ...
              {userAppliedCampaigns?.map((job, index) => {
                ...
                return (
                  <HightlightJobCard
                    ...
                    disableButton={true}
                    disableTitle={
                      userRecruitmentCampaignStatus === 302 ||
                      userRecruitmentCampaignStatus === 701
                        ? 'Đã từ chối bởi bạn'
                        : userRecruitmentCampaignStatus === 601
                        ? 'Đã từ chối bởi công ty'
                        : ''
                    }
                    key={index}
                    job={job}
...
export default CancelledJobPage
