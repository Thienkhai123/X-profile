...
const CourseManySourceItemNew = (props) => {
  const {
    imageUrl,
    name,
    company,
      ...
      <div className="group h-full">
        ...
        >
          ...
          <div className="flex flex-col h-full justify-between items-start xl:pt-4 pt-2 xl:px-5 px-3 xl:pb-6 pb-3">
            ...
            <div>
              <p className="text-[#1B75BB] md:text-p16 text-p12">
      ...
      >
          ...
          {isCompanyCourse && (
            <Fragment>
              <div className="md:block hidden absolute right-6 top-0">
                <XProfileIcon name="flagXprofileBlack" />
              </div>
              <div className="md:hidden absolute right-3 top-0">
                <XProfileIcon name="flagXprofileBlack" width="38" height="55" />
              </div>
            </Fragment>
          )}
        </div>
        <div className="xl:pt-4 pt-2 xl:px-5 px-3 xl:pb-6 pb-3 flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between overflow-hidden">
            <div className="flex items-center gap-1 ">
              <XProfileIcon name="play2Icon" fill="#1B75BB" />
              <p className="xl:text-p16 text-p12 text-[#1B75BB] line-clamp-1">
                {totalVideoCount || 0} Videos
              </p>
              <span className="xl:text-p16 text-p12 text-[#1B75BB]">-</span>
              <p className="xl:text-p16 text-p12 text-[#1B75BB] line-clamp-1">
          ...
          <div className="flex items-center justify-between ">
            <div className="flex items-center gap-1">
              <XProfileIcon name="user2" fill="#1B75BB" />
              <p className="xl:text-p16 text-p12 text-[#1B75BB]">
                {totalUserCount?.toLocaleString() || 0}
              </p>
            </div>
            <div className="flex items-center gap-1">
              <XProfileIcon name="bubbleMess2" fill="#1B75BB" />
              <p className="xl:text-p16 text-p12 text-[#1B75BB]">
...
CourseManySourceItemNew.propTypes = {}
CourseManySourceItemNew.defaultProps = {
  name: '',
  imageUrl: '',
  company: '',
  totalTime: 0,
...
export default CourseManySourceItemNew
