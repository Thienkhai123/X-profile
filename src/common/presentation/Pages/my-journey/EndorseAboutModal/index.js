...
const EndorseAboutModal = (props) => {
  ...
  return (
    <div className="w-full">
      ...
      >
        <p className="text-p20-bold mb-5 max-w-[282px] text-center">
          Endorse about {name || ''}
        </p>
        ...
        <div className="w-full mb-10">
          <p className="text-p18 mb-3">{name} Message</p>
          <p className="text-[#1B75BB] text-p16">
            If you are satisfied with my performance during our time together as
            a team, please let me know!
          </p>
        </div>
        <div className="w-full">
          <p className="text-p18 mb-4">Your Endorse</p>
          <div className="mb-8">
            <Controller
              control={control}
              name="content"
...
export default EndorseAboutModal
