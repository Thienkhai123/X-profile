  ...
  return (
    <Fragment>
      <div className="md:block hidden group  hover:-translate-y-2  cursor-pointer transition-all duration-200">
        <div className="xl:w-[306px] h-[174px] hover:shadow-[0_8px_24px_0px_rgba(11,74,137,0.04)] rounded-3xl bg-[#F5F6F7] border border-[#EDF0F2]">
          ...
          <div className="hidden  group-hover:block  p-6 h-full animate-fadeIn ">
...
export default SkillDatabaseCard
