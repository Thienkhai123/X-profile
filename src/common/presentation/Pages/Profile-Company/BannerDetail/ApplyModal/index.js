  ...
  return (
    <div className="relative">
      <div className="flex justify-end ">
        <div className="absolute cursor-pointer" onClick={() => toggleModal()}>
      ...
      <div className="flex flex-col items-center mb-[32px]">
        <div className="flex justify-center  mb-[16px] w-[311px]  ">
          <p className="text-p20-bold text-neutral text-center">
            Bạn vẫn chưa xác nhận lời mời phỏng vấn từ công ty {companyName}!
          </p>
        </div>
        <div className="flex justify-center  mb-[24px]  ">
          <p className="text-p16 text-grey-1 text-center">
            Để lưu hoặc ứng tuyển công việc mới, bạn vui lòng xác nhận lời mời
            phỏng vấn từ công ty
        ...
        <div className="flex justify-center  mb-[16px]  ">
          <p className="text-p16 text-grey-1 text-center">
            ...
            nếu bạn chưa xác nhận trước ngày{' '}
