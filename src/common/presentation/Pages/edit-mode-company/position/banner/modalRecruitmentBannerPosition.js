...
const ModalRecruitmentBannerPosition = ({
  toggleModal = () => {},
  jobCategory = [],
  addressBooks = [],
  isOpen = false
  ...
  const { companyId, departmentPositionId } = query || {}
    ...
    <div className=" w-full mt-[40px]">
      ...
      <div className=" ">
        <form onSubmit={handleSubmit(submit)}>
          <div className="lg:flex lg:items-start gap-[80px] ">
            <div className="min-w-[575px]  ">
              ...
              <div>
                ...
                <div className="relative" ref={refTypeOpt}>
                  ...
                  >
                    ...
                    />
                    <XProfileIcon name="arrowDown" stroke="black" size="1.3" />
                  </div>
                  {showTypeOpt && (
              ...
              <div>
                ...
                <p className="text-button text-p18 mb-1">{pushTime || 0} lần</p>
                <Controller
                  control={control}
                  key={'rangeSlider'}
                  name="pushTime"
              ...
              <div>
                ...
                <p className="text-button text-p18">{matchingPercent || 0}%</p>
            ...
            <div className="min-w-[440px] overflow-y-scroll custom-scrollbar ">
              <div className="border border-grey-4 rounded-[16px] p-8 lg:mt-0 mt-6 ">
                <p className="text-h4 mb-4 text-neutral">Chi phí (tạm tính)</p>
                ...
                <div className="flex justify-between mb-6">
                  <div>
                    <p className="text-p18 text-neutral">Số lần đẩy tin/ngày</p>
                    <p className="text-p18 text-grey-2 h-7">
        ...
        <div className="mt-2">
          <p className="text-p18 text-grey-2 ">
            Gói dịch vụ nâng cao (Xem CV {`>`} 80% phù hợp, Đăng tin tuyển dụng
            với KOLs trong ngành){' '}
            <a
              href="#"
              className="text-semantic-text-link hover:opacity-80 underline"
            >
              Tìm hiểu thêm
            </a>
          </p>
...
export default ModalRecruitmentBannerPosition
