...
const CoursePartnerList = (props) => {
  const { listCourse = [], handleFavouriteCourse, handleLinkCourse } = props
...
CoursePartnerList.propTypes = {}

export default CoursePartnerList
