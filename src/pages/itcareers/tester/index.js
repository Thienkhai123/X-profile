...
import TestTerSvg from 'common/presentation/Pages/landing/tester/testerSvg'
import TesterMobile from 'common/presentation/Pages/landing/tester/testerSvgMobile'
...
const TesterLandingPage = () => {
  ...
  const download = (name = 'tester') => {
    fetch('/images/Landing/ITCareer.png')
      .then((response) => response.blob())
      .then((blob) => {
        const url = window.URL.createObjectURL(blob)
        const a = document.createElement('a')
        a.href = url
        a.download = `tester.png`
  ...
  const handleShareBlog = () => {
    if (window !== undefined) {
      window.open('https://blog.xprofile.vn/', '_blank')
    }
  }
  ...
  const shareFacebook = () => {
    document.getElementById('shareFacebookTester').click()
  }

  const shareLinkedin = () => {
    document.getElementById('shareLinkedinTester').click()
  }
  ...
  return (
    <div className="bg-yellow-survey">
      <div className="flex-1 max-w-[1240px] mx-auto px-[24px] xl:px-0 ">
        <MetaSeo
          title="Tester - Bạn là ai trong thế giới IT - X-Profile"
          titleContent={'Tester'}
          descContent={'Tester'}
          imageContent="https://he44r2a3tgobj.vcdn.cloud/p/Website/SurveyITCareers/X-Profile_Tester-1.png"
          urlContent="https://xprofile.vn/itcareers/tester"
        />
      ...
      <div className="relative">
        <Modal
          ...
          modalStyle="w-[100vw] h-[100vh]   flex flex-col justify-between items-center pt-[12%] fixed bg-black/30 z-[200] left-[calc(0%)] top-[calc(0%)]"
          childStyle="w-auto "
        >
          <div className="flex justify-center relative">
            <div className="w-[48.313vw] h-[90.271vw] relative">
              <Image
                layout="fill"
                alt=""
                src="/images/Landing/ITCareerMobile.png"
                quality={100}
              />
            </div>
          </div>
