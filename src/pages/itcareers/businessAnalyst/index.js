...
import BusinessAnalystSvg from 'common/presentation/Pages/landing/businessAnalyst/businessAnalystSvg'
import BusinessAnalystSvgMobile from 'common/presentation/Pages/landing/businessAnalyst/businessAnalystSvgMobile'
...
const BusinessAnalystLandingPage = () => {
  ...
  const download = () => {
    fetch('/images/Landing/businessAnalystDow.png')
      .then((response) => response.blob())
      .then((blob) => {
        const url = window.URL.createObjectURL(blob)
        const a = document.createElement('a')
        a.href = url
        a.download = `BusinessAnalyst.png`
  ...
  const handleShareBlog = () => {
    if (window !== undefined) {
      window.open('https://blog.xprofile.vn/tag/business-analyst/', '_blank')
    }
  }
  ...
  const shareFacebook = () => {
    document.getElementById('shareFacebookBusinessAnalyst').click()
  }

  const shareLinkedin = () => {
    document.getElementById('shareLinkedBusinessAnalyst').click()
  }

  const handleShareInsMobile = async () => {
    const response = await fetch('/images/Landing/businessAnalystDowMobile.png')
    const blob = await response.blob()
    const filesArray = [
      new File([blob], 'business_Analyst.jpg', {
        type: 'image/jpeg',
    ...
    <div className="bg-yellow-survey">
      <div className="flex-1 max-w-[1240px] mx-auto px-[24px] xl:px-0 ">
        <MetaSeo
          ...
          titleContent={'Business Analyst'}
          descContent={'Business Analyst'}
          imageContent="https://he44r2a3tgobj.vcdn.cloud/p/Website/SurveyITCareers/X-Profile_BA-1.png"
          urlContent="https://xprofile.vn/itcareers/businessAnalyst"
        />
          ...
          <div className="flex gap-[68px]">
            <div className="xl:pt-[80px] pt-0">
              <div className="flex flex-col xl:gap-[16px] gap-[8px] max-w-[626px] xl:mb-[80px] mb-[48px]">
                <p className="sm:text-p48 text-h3 text-neutral ">
                  Wow, bạn chính là
                </p>
                <p className="sm:text-p48 text-h3 text-neutral ">
                  QUÂN SƯ CÔNG NGHỆ
                ...
                <p className="sm:text-p24 text-p16 text-neutral">
                  Người trong ngành gọi là Business Analyst (BA) đấy!
                </p>
                <p className="sm:text-p20 text-p14 text-semantic-green italic">
                  / Vừa phân tích, vừa vẽ vời, vừa lựa lời phản hồi cho khách! /
                </p>
              </div>
              <div className="xl:hidden block justify-end top-0 mb-[32px]">
                <Image
                  src="/images/Landing/BA.png"
                  width={578}
                  height={541}
                  alt=""
                  priority
              ...
              <div>
                <div className="hidden md:block xl:w-[622px] w-full relative">
                  <BusinessAnalystSvg download={download} />
                  ...
                  <div className="flex justify-center w-full">
                    <div className="flex justify-center w-[277px] relative">
                      <div className="absolute bottom-[76px] right-[12px] opacity-0">
                        <LinkedinShareButton
                          url={`https://xprofile.vn${router?.pathname}`}
                          quote="Business analyst"
                          hashtag="#XProfile"
                    ...
                    <div className="flex justify-center ">
                      <div className="hidden">
                        <FacebookShareButton
                          ...
                          hashtag="#XProfile"
                          className="Demo__some-network__share-button"
                          id="shareFacebookBusinessAnalyst"
                        >
          ...
          <div className="flex justify-center">
            <div className="w-[48.313vw] h-[90.271vw] relative">
              <Image
                ...
                alt=""
                quality={100}
                src="/images/Landing/businessAnalystDowMobile.png"
              />
            </div>
          </div>
...
export default BusinessAnalystLandingPage
