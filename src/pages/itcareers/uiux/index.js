...
import UiuxSvg from 'common/presentation/Pages/landing/uiux/uiuxSvg'
import UiuxSvgMobile from 'common/presentation/Pages/landing/uiux/uiuxSvgMobile'
...
const UIUXLandingPage = () => {
  ...
  const download = (name = 'UIUX') => {
    fetch('/images/Landing/ITCareerUIUX.png')
  ...
  const handleShareBlog = () => {
    if (window !== undefined) {
      window.open(
        'https://blog.xprofile.vn/tuyen-ui-ux-designer-nhung-tieu-chuan-quan-trong/'
      )
    }
  }
  ...
  const handleShareInsMobile = async () => {
    const response = await fetch('/images/Landing/ITCareerUIUXMobile.png')
    const blob = await response.blob()
    const filesArray = [
      new File([blob], 'ui_ux.jpg', {
        type: 'image/jpeg',
  ...
  const shareFacebook = () => {
    const buttonShareFB = document.getElementById('shareFacebookUIUX')
    if (buttonShareFB) {
      buttonShareFB.click()
    }
  }
  ...
  const shareLinkedin = () => {
    const buttonShareLinkedIn = document.getElementById('shareLinkedInUIUX')
    if (buttonShareLinkedIn) {
      buttonShareLinkedIn.click()
    }
  }
  useEffect(() => {
    const element = document.getElementById('download-survey-uiux')
    if (element) {
  ...
  return (
    <div className="bg-yellow-survey">
      <div className="flex-1 max-w-[1240px] mx-auto px-[24px] xl:px-0 ">
        <MetaSeo
          title="UI/UX Designer - Bạn là ai trong thế giới IT - X-Profile"
          titleContent={'UI/UX Designer'}
          descContent={'UI/UX Designer'}
          urlContent="https://xprofile.vn/itcareers/uiux"
          imageContent="https://he44r2a3tgobj.vcdn.cloud/p/Website/SurveyITCareers/X-Profile_UIUXDesigner-1.png"
        />
        ...
        <div className="py-[16px] xl:py-[80px]  xl:px-0">
          ...
          <div className="flex gap-[58px]">
            ...
            <div className="xl:flex hidden justify-end  sticky top-0 w-[600px] h-[468px]">
              <Image
                priority
                quality={100}
                objectFit="contain"
          ...
          <div className="flex justify-center">
            <div className="w-[54.313vw]  h-[104.271vw] relative">
              <Image
                ...
                priority
                objectFit="contain"
                src="/images/Landing/ITCareerUIUXMobile.png"
                quality={100}
              />
            </div>
          </div>
