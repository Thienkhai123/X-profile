...
const MySkillPage = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Hành trình của tôi - Kỹ năng của tôi</title>
      </Head>
          ...
          <div className="xl:max-w-[1440px] mx-auto">
            ...
            <div className="xl:flex gap-8">
              ...
              <div className="xl:w-[279px] xl:block hidden">
                <MyJourneySideBanner title="Tích luỹ thêm nhiều kỹ năng, để có thể thu hút được nhiều cơ hội việc làm tốt đến với bạn!" />
              </div>
            </div>
          </div>
        </div>
