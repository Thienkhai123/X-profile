...
const Search = (props) => {
  ...
  const listBreadCrumbs = [
    ...
    {
      name: nameCategory ?? 'Tất cả khoá học'
    }
  ]
  ...
  useEffect(() => {
    if (baseCategories) {
      ...
      if (tmp) {
        ...
        dispatch(updateCurrentCategories('Tất cả khoá học'))
      }
    }
    return () => {}
    // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    <>
      ...
      <div className="bg-white w-full h-full">
        <div className="lg:mx-auto ">
          <div className="max-lg:px-5 max-w-[1140px] mx-auto pb-8">
            <div className="mb-2 mt-3">
              <BreadCrumbs
                ...
                nameList={listBreadCrumbs}
              />
            </div>
            <div className="flex items-center  justify-center border-b border-grey-4 pb-8">
              <div className="flex">
                <p className="text-p28-bold lg:text-p20-bold pr-6">
          ...
          <div className="flex gap-5 flex-col lg:flex-row max-w-[1140px] mx-auto ">
            <div className="max-w-[340px] w-full">
              <div className="hidden lg:block  lg:w-[266px] lg:mb-10">
                <FilterCourse
                  listCategory={baseCategories}
                  payloadFilter={payloadFilter}
